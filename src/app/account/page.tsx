      ...
      <div className="mt-8 grid gap-8 mx-4 lg:mx-32 lg:grid-cols-2">
        <div className="p-4 rounded">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center">
              ...
              <p className="ml-6 text-gray-500 text-sm hover:underline cursor-pointer">Lost Your Password?</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 rounded">
          ...
          <input
            ...
            className="w-full sm:w-[300px] my-2 border border-gray-400 rounded p-2 mb-4"
          />
          <p className="text-gray-500 my-4">A link to set a new password will be sent to your email address.</p>
          <p className="text-gray-500 mb-4">
            ...
            <Link href="/privacy-policy" className="font-bold text-gray-700">
              privacy policy
            </Link>
            .
          </p>
      ...
      <div className="bg-[#FDF7FC] px-4 py-16">
        <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">For all orders over $50</p>
          </div>
          <div className="space-y-2">
